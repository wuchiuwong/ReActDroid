...
class Main:
    def __init__(self):
        app_idx = 22
        crash_info = get_crash_info_mydata_all(app_idx)
        # input_cont = {"email": "lu@gml.com", "pass": "12331986"}
        # input_cont = {"email": "2w246612418@qq.com", "pass": "zaq13edc"}
        # input_cont = {"all": "1111111111111111111111111111111111111111111111111111111111111"}
        input_cont = {}
        crash_info.setdefault("input_cont", input_cont)
        install_app(crash_info["app_pkg"], crash_info["app_name"] + ".apk", app_dir="MyData")
        perform_logcat()
    ...
    def step(self):
        ...
        if observe_res["page_id"] == "out of app" or observe_res["page_id"] == "empty page":
