...
class Main:
    def __init__(self):
        app_idx = 7
        crash_info = get_crash_info_review(app_idx)
        # input_cont = {"email": "lu@gml.com", "pass": "12331986"}
        # input_cont = {"email": "lu@gml.com", "pass": "12331986"}
        # input_cont = {"name": "", "pass": ""}
        # input_cont = {"all": "android"}
        crash_info["input_cont"] = {"all": "android"}
        # install_app(crash_info["app_pkg"], crash_info["app_path"], app_dir="Reviews")
        perform_logcat()
